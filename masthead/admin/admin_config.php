...
class masthead_ui extends e_admin_ui
{
    ...
    public function init()
    {
        ...
        $link = e_THEME . $sitetheme  . "/themeoptions/masthead/admin_config.php";
		if (file_exists($link))
		{     
				$tag = "<a href='".$link."'>Click here</a>"; 
				$mes->addWarning("Your theme has direct support for this plugin.".$tag );
				echo $mes->render();
		}
