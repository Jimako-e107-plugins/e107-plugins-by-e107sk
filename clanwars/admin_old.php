...
if(in_array($action, array('Config'))) {
  e107::js('footer', e_PLUGIN.'clanwars/includes/config.js', 'jquery');
}
elseif(in_array($action, array('EditWar'))) {
$format =   $conf['dateformat'];
/* change in date format 
yyyy = yy for datepicker
yy = y for datepicker 
*/
 
e107::js('footer', e_PLUGIN.'clanwars/includes/jquery.autocomplete.js', 'jquery'); 
e107::js('footer', e_PLUGIN.'clanwars/includes/admineditwar.js', 'jquery');
