...
function addData() {
    ...
    http.open("GET","admin_old.php?AddMail&uname=" + escape(uname) + "&address=" + escape(address)+"&code="+Math.floor(Math.random()*99999),true);
...
function delData(id) {
	...
	if(sure){
		http.open("GET","admin_old.php?DelMail&mid=" + id+"&code="+Math.floor(Math.random()*99999),true);
...
function saveData(id) {	
	...
	http.open("GET","admin_old.php?SaveMail&mid=" + id + "&uname=" + escape(uname) + "&address=" + escape(address)+"&code="+Math.floor(Math.random()*99999),true);
...
function ChangeStatus(id){
	...
	http.open("GET","admin_old.php?MailStatus&mid=" +  parseInt(id) + "&status=" + parseInt(img.value)+"&code="+Math.floor(Math.random()*99999),true);
