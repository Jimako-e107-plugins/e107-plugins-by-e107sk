...
if (!((defined('WARS_ADMIN') or defined('WARS_SPEC')) && (preg_match("/admin_old\.php\?Screens/i", $_SERVER['REQUEST_URI']) or preg_match("/clanwars\.php\?Screens/i", $_SERVER['REQUEST_URI'])))) {
...
if(ADMIN){
	$action = "admin_old.php?Upload&wid=$wid";
}else{
