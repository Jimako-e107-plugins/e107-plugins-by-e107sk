...
if (!defined('WARS_ADMIN') or !preg_match("/admin_old.php\?Config/i", $_SERVER['REQUEST_URI'])) {
...
/******  REPLACE OLD GLOBALS END  *********************************************/
  ...
  /*<label><input type='radio' name='colorbox' value='1' ".(($conf['colorbox'])?"checked":"").">"._WBOXES."</label>&nbsp;&nbsp;<label>
   <input type='radio' name='colorbox' value='0' ".(($conf['colorbox'])?"":"checked").">"._WTEXT."</label> 
   <label><input type='radio' name='showip' value='1' ".(($conf['showip'])?"checked":"").">"._YES."</label>&nbsp;&nbsp;<label><input type='radio' name='showip' value='0' ".(($conf['showip'])?"":"checked").">"._NO."</label> 
   <label><input type='radio' name='seperate' value='1' ".(($conf['seperate'])?"checked":"").">"._YES."</label>&nbsp;&nbsp;<label><input type='radio' name='seperate' value='0' ".(($conf['seperate'])?"":"checked").">"._NO."</label>
  <label><input type='radio' name='showteamflag' value='1' ".(($conf['showteamflag'])?"checked":"").">"._YES."</label>&nbsp;&nbsp;<label><input type='radio' name='showteamflag' value='0' ".(($conf['showteamflag'])?"":"checked").">"._NO."</label>
  <label><input type='radio' name='warssummary' value='1' ".(($conf['warssummary'])?"checked":"").">"._YES."</label>&nbsp;&nbsp;<label><input type='radio' name='warssummary' value='0' ".(($conf['warssummary'])?"":"checked").">"._NO."</label>
  */
	$text =  " 
	<table class='table'><tr><td>		
	
	<form method='post' action='admin_old.php?SaveConfig'>
	<table class='table adminform' id='configtable'>    <tbody>
	<tr> 
		<td align='left' colspan='2'><b><span class='warstitle'>"._WGENERAL."</span></b></td>
	</tr>		   
	<tr> 
		<td align='left'>"._WWARSPP.": </td>
		<td align='left'>".$frm->renderElement('rowsperpage', $conf['rowsperpage'], array('type'  => 'text', 'writeParms' => array('size'=>'5', 'maxlength'=>'3' )))."</td>
	  </tr> 
  <tr>
		<td align='left' nowrap>"._WBOXTEXT.": </td>
	<td align='left' nowrap>".$frm->renderElement('colorbox', $conf['colorbox'], array('type'  => 'boolean', 'writeParms' => array('enabled'=>_WBOXES, 'disabled'=>_WTEXT )))."</td>
	</tr>
	<tr>
		<td align='left' nowrap>"._WSHOWIPPASS.": </td>
		<td align='left'>".$frm->renderElement('showip', $conf['showip'], array('type'  => 'boolean', 'writeParms' => array('enabled'=>_YES, 'disabled'=>_NO )))."</td>
	</tr>
	<tr>
		<td align='left' nowrap>"._WSEPNEXFIN.": </td>
		<td align='left'>".$frm->renderElement('seperate', $conf['seperate'], array('type'  => 'boolean', 'writeParms' => array('enabled'=>_YES, 'disabled'=>_NO )))."</td>
	</tr>
	<tr>
		<td align='left' nowrap>"._WSHOWREAMSFLAG.": </td>
		<td align='left'>".$frm->renderElement('showteamflag', $conf['showteamflag'], array('type'  => 'boolean', 'writeParms' => array('enabled'=>_YES, 'disabled'=>_NO )))."</td>
	</tr>
	<tr>
		<td align='left' nowrap>"._WSHOWWARSSUMM.": </td>
		<td align='left'>".$frm->renderElement('warssummary', $conf['warssummary'], array('type'  => 'boolean', 'writeParms' => array('enabled'=>_YES, 'disabled'=>_NO )))."</td>
	</tr>
	<tr> 
	...
	<tr> 
		<td  class='bg-primary' align='left' colspan='2'><b><span class='warstitle'>"._WDATEFORMATS."</td>
	</tr>";
	...
	<tr> 
		<td  class='bg-primary' align='left' colspan='2'><b><span class='warstitle'>"._WSPECPRIV."</span></b></td>
	</tr>";
$text .= 
  "<tr>
		<td align='left'>"._WUSERSCANADDWARS.":</td>
		<td align='left'>
    ".$frm->renderElement('newaddwarlist', $conf['addwarlist'], array('type'  => 'userclass', 'writeParms' => array( )))."
    </td>
	</tr>";  
  /*
	<tr>
...
//<input id='addtolist' type='text' style='width:96%;' title='"._WCLCKONNAMETOADD."' onKeyPress='return submitenter(event);'>
$text .= 
  "<tr>
		<td align='left'>"._WADDUSRTOLIST.":</td>
		<td align='left'>
    <input id='newaddwarlist' name='newaddwarlist' value='".$conf['addwarlist']."' type='hidden'>
    ".$frm->renderElement('addtolist', $conf['addtolist'], array('type'  => 'user', 'writeParms' => array('limit'=>'99' )))."
    </td>
	</tr>  */
  
/* <label><input type='radio' name='caneditwar' value='1' ".(($conf['caneditwar'])?"checked":"").">"._YES."</label>&nbsp;&nbsp;<label><input type='radio' name='caneditwar' value='0' ".(($conf['caneditwar'])?"":"checked").">"._NO."</label>*/ 
/* <label><input type='radio' name='requireapproval' value='1' ".(($conf['requireapproval'])?"checked":"").">"._YES."</label>&nbsp;&nbsp;<label><input type='radio' name='requireapproval' value='0' ".(($conf['requireapproval'])?"":"checked").">"._NO."</label> */
$text .= "
	<tr>
		<td align='left'>"._WEDITWARSTOO.": </td>
		<td align='left'>".$frm->renderElement('caneditwar', $conf['caneditwar'], array('type'  => 'boolean', 'writeParms' => array('enabled'=>_YES, 'disabled'=>_NO )))."</td>
	</tr>
	<tr>
		<td align='left'>"._REQUIREAPPROVAL.": </td>
		<td align='left'>".$frm->renderElement('requireapproval', $conf['requireapproval'], array('type'  => 'boolean', 'writeParms' => array('enabled'=>_YES, 'disabled'=>_NO )))."</td>
	</tr>
	<tr> 
		<td class='bg-primary' align='left' colspan='2'><b><span class='warstitle'>"._WWARSMAIL."</span></b></td>
	</tr>
	<tr>
...
$text .= "  
	<tr> 
		<td class='bg-primary' align='left' colspan='2'><b><span class='warstitle'>"._WMAPSSS."</span></b></td>
	</tr>
	<tr>
	...
	<tr> 
		...
		<td align='left'><input type='text' name='mapwidth' value='".$conf['mapwidth']."' size='5' maxlength='5'> px / % </td>
	</tr>
	<tr> 
		<td class='bg-primary' align='left' colspan='2'><b><span class='warstitle'>"._WLINEUP."</span></b></td>
	</tr>
	<tr>			
	...
	<tr> 
		<td align='left' colspan='2'><b><span class='warstitle'>"._WSCRSHOTS."</span></b></td>
	</tr>
	<tr> 
	...
	<tr> 
		<td class='bg-primary' align='left' colspan='2'><b><span class='warstitle'>"._WCOMS."</span></b></td>
	</tr>
	<tr>
	...
	<tr> 
		<td align='left' colspan='2'><b><span class='warstitle'>"._WEDITWPAGE."</span></b></td>
	</tr>
	<tr>
