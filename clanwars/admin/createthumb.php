...
if (!((defined('WARS_ADMIN') or defined('WARS_SPEC')) && (preg_match("/admin_old\.php\?CreateThumb/i", $_SERVER['REQUEST_URI']) or preg_match("/clanwars\.php\?CreateThumb/i", $_SERVER['REQUEST_URI'])))) {
...
if(ADMIN){
	header("Location: admin_old.php?Screens&wid=$wid");
}else{
