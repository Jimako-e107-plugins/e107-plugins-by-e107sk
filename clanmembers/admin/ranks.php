...
/******  REPLACE OLD GLOBALS END  *********************************************/
	...
	<table class='fborder table adminlist'>
		<tr>
...
if($sql->count("clan_members_ranks") > 0){
	...
	$text .= "<table id='rankstable'  class='fborder table adminlist'> ";
	$text .= "<thead><tr>
	...
	if($result = $sql->retrieve("clan_members_ranks", "*", "ORDER BY rankorder ASC", true)) {
