...
if($orderorder !=""){
	...
	$result = e107::getDb()->update("clan_members_config",  "memberorder='".$listorder."'");
}
...
if($neworder !=""){
	...
	$result = e107::getDb()->update("clan_members_config", "listorder='".serialize($listorder)."'");
}
