		...
		$text .= "<table  class='table adminform'>
			...
			$text .= "</select></td>
				...
				$text .= "<tr>
					<td colspan='2' align='left'>
					<div id='ordertitle'>
						<div class='jm-collapse'><b>"._ORDERBY." -</b></div>
						<div class='jm-expand'><b>"._ORDERBY." +</b></div>
					</div>
			...
			//Drag and Drop	info
				...
				$listorder = '<br /><div id="memberslist">
						<div class="jm-collapse"><b>'._LISTORDER.' -</b></div>
						<div class="jm-expand"><b>'._LISTORDER.' +</b></div></div>';
...
$text .= '<tr id="profile8" style="display:'.$showprofile.';">
	...
	$profileorder = '<br /><div id="hardware">
			<div class="jm-collapse"><b>'._PROFILEORDER.' -</b></div>
			<div class="jm-expand"><b>'._PROFILEORDER.' +</b></div></div>';
