...
if($filename !=""){
	...
	if($ext != "jpg" && $ext != "jpeg" && $ext != "gif" && $ext != "png"){
		...
		e107::getDb()->update("clan_members_awards", "image='$awardimage' WHERE rid='$rid'");
	}
}
}

e107::getDb()->update("clan_members_awards", "title='$awardtitle', description='$awarddescription' WHERE rid='$rid'");
