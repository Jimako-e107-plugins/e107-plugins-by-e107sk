	...
	if($conf['galfilesize'] == 0 || $_FILES['newimage']['size'] <= ($conf['galfilesize'] * 1024)){
		...
		if($filename !=""){		
			...
			if($ext != "jpg" && $ext != "jpeg" && $ext != "gif" && $ext != "png"){
				echo"<div class='text-center'><br />"._ONLYIMGSALLOWED."<br /><br /></div>";
				...
				e107::getDb()->insert("clan_members_gallery", array("userid" => $userid, "url" => $image));
				header("Location: $return");

			}	
		}
	}else{
		echo"<div class='text-center'><br />"._IMGNOTUPLMAXSIZE.$conf['galfilesize']."kB.<br /><br /></div>";
