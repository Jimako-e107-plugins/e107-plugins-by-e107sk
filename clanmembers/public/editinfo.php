...
if (!defined('CM_PUB') or (!$conf['allowchangeinfo'] && !$conf['allowupimage'])) {
  //  header("Location:modulesx.php?name=$module_name");
	die ("Access Denied");
}
...
$row = $sql->retrieve("clan_members_info", "*", "userid='$memberid'");
...
$text = "<table width='310' class='table'><tr><td align='left'>";
$text .= "<form name='memberinfo' method='post' action='clanmembers.php?saveinfo' enctype=\"multipart/form-data\">";
	if($conf['allowchangeinfo']){
	$text .= "<div id='general'  >
			<div class='jm-collapse'>"._GENERAL." -</div>
			<div class='jm-expand'>"._GENERAL." +</div></div>
		
	<div id='memberprofile'>
	<table class='table' id='editinfo'>";
	...
	$text .= "<tr>
			...
			<td align='left'><input type='text' name='realname' value='$realname' size='25' maxlength='100' class='tbox form-control'></td>
		</tr>";
	...
	$text .= "<tr>
			...
			<td align='left'><label><input type='radio'  name='gender' value='Male' $male>Male</label> <label>
      <input type='radio'   name='gender' value='Female' $female>Female</label></td>
		</tr>";
		...
		$text .= "<tr>
			...
			<td align='left'>			
			<select name='dd' id='dd' class='tbox ' $disabled>";
			for($i=1;$i<=31;$i++){
			...
			$text .= "</select>
			<select name='mm' id='mm' class='tbox  ' $disabled>";
			for($i=1;$i<=12;$i++){
				if($mm == $i){$sel = "selected";}else{$sel="";}
				$text .= "<option value='$i' $sel>".$month[$i]."</option>";
			}
			$text .= "</select>			
			<select name='yyyy' id='yyyy' class='tbox  ' $disabled>";
			$thisyear = date("Y");
	...
	$text .= "<tr>
			...
			<td align='left'><input type='text' name='location' value='$location' size='25' maxlength='100' class='tbox form-control' ></td>
		</tr>";
	}if(VisibleInfo("Country")){
	$text .= "<tr>
			<td align='left' width='120'>"._INFOCountry.":&nbsp;</td>
			<td align='left'><select name='country' class='tbox form-control' onchange=\"updateFlag(this)\">";
	...
	$text .= "<tr>
			...
			<td align='left'><input type='text' name='xfire' value='$xfire' size='20' maxlength='100' class='tbox form-control'></td>
		</tr>";
	}if(VisibleInfo("Steam ID")){
	$text .= "<tr>
			<td align='left' width='120'>"._INFOSteamID.":&nbsp;</td>
			<td align='left'><input type='text' name='steam' value='$steam' size='20' maxlength='100' class='tbox form-control'></td>
		</tr>";
	}
	$text .= "</table></div>";
	}
	//User Image
	if(VisibleInfo("User Image") && $conf['allowupimage']){
	$text .= "<br /> <div id='uimage'>
		<div class='jm-collapse'>"._INFOUserImage." -</div>
		<div class='jm-expand'>"._INFOUserImage." +</div></div> 
		<div id='userimage'>
		<table class='table'>";
	...
	if($conf['enableprofile'] && $conf['enablehardware'] && $conf['allowchangeinfo']){
		//Hardware Profile
		$text .= "<br /> <div id='hardware'>
				<div class='jm-collapse'>"._HARDWPROFILE." -</div>
				<div class='jm-expand'>"._HARDWPROFILE." +</div></div> 
			<div id='hardwareprofile'>
			<table class='table'>
			<tr>
				<td align='left' width='120'>"._INFOmanufacturer.":&nbsp;</td>
				<td align='left'><input type='text' name='manufacturer' value='$manufacturer' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOcpu.":&nbsp;</td>
				<td align='left'><input type='text' name='cpu' value='$cpu' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOmainboard.":&nbsp;</td>
				<td align='left'><input type='text' name='mainboard' value='$mainboard' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOmemory.":&nbsp;</td>
				<td align='left'><input type='text' name='memory' value='$memory' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOhdd.":&nbsp;</td>
				<td align='left'><input type='text' name='hdd' value='$hdd' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOvga.":&nbsp;</td>
				<td align='left'><input type='text' name='vga' value='$vga' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOmonitor.":&nbsp;</td>
				<td align='left'><input type='text' name='monitor' value='$monitor' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOsound.":&nbsp;</td>
				<td align='left'><input type='text' name='sound' value='$sound' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOspeakers.":&nbsp;</td>
				<td align='left'><input type='text' name='speakers' value='$speakers' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOkeyboard.":&nbsp;</td>
				<td align='left'><input type='text' name='keyboard' value='$keyboard' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOmouse.":&nbsp;</td>
				<td align='left'><input type='text' name='mouse' value='$mouse' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOsurface.":&nbsp;</td>
				<td align='left'><input type='text' name='surface' value='$surface' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
			<tr>
				<td align='left'>"._INFOos.":&nbsp;</td>
				<td align='left'><input type='text' name='os' value='$os' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>
					<tr>
				<td align='left'>"._INFOpccase.":&nbsp;</td>
				<td align='left'><input type='text' name='pccase' value='$pccase' size='25' maxlength='50' class='tbox form-control'></td>
			</tr>";
	...
	<input type='submit' class='button btn' value='"._SAVECHANGES."'>
</form>";
