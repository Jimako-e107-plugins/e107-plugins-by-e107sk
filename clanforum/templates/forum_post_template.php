...
|
|     $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_plugins/forum/templatesx/forum_post_template.php $
|     $Revision: 11678 $
...
if(!$poll_form)
{
	if(is_readable(e_PLUGIN."poll/poll_class.php")) {
		...
		$pollo = new poll;
		$poll_form = $pollo -> renderPollForm(CLAN_FORUM_FOLDER);
	}
}
...
$FORUM_CRUMB[CLAN_FORUM_FOLDER]['sep'] = " :: ";
