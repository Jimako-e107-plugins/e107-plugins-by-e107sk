...
switch($this->parm){
	...
	case 6:
		$this -> rssQuery =
		"SELECT t.thread_thread, t.thread_id, t.thread_name, t.thread_datestamp, t.thread_parent, t.thread_user, t.thread_views, t.thread_lastpost, t.thread_lastuser, t.thread_total_replies, u.user_name, u.user_email FROM ".CLAN_FORUM_THREAD." AS t
		LEFT JOIN #user AS u ON SUBSTRING_INDEX(t.thread_user,'.',1) = u.user_id
		LEFT JOIN ".CLAN_FORUM_TABLE." AS f ON f.forum_id = t.thread_forum_id
	...
	case posts:
	case 7:
		$this -> rssQuery = "SELECT tp.thread_name AS parent_name, t.thread_thread, t.thread_id, t.thread_name, t.thread_datestamp, t.thread_parent, t.thread_user, t.thread_views, t.thread_lastpost, t.thread_lastuser, t.thread_total_replies, f.forum_id, f.forum_name, f.forum_class, u.user_name, u.user_email FROM ".CLAN_FORUM_THREAD." AS t
		LEFT JOIN #user AS u ON SUBSTRING_INDEX(t.thread_user,'.',1) = u.user_id
		LEFT JOIN ".CLAN_FORUM_THREAD." AS tp ON t.thread_parent = tp.thread_id
		LEFT JOIN ".CLAN_FORUM_TABLE." AS f ON f.forum_id = t.thread_forum_id
