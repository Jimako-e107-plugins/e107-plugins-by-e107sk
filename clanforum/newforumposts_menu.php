...
include_lan(CLAN_FORUM_APP."languages/".e_LANGUAGE."/lan_newforumposts_menu.php");
...
f.forum_id, f.forum_name, f.forum_class, u.user_name, fp.forum_class FROM ".CLAN_FORUM_THREAD." AS t 
...
LEFT JOIN ".CLAN_FORUM_TABLE." AS f ON (f.forum_id = t.thread_forum_id AND f.forum_class IN (".USERCLASS_LIST."))
